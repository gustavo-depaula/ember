...
export function OrnamentalRule() {
	return (
		<YStack alignItems="center" paddingVertical="$md">
			<Image source={markerImage} style={styles.marker} resizeMode="contain" />
		</YStack>
	)
}
...
export function HeaderFlourish() {
	return (
		<YStack alignItems="center" paddingBottom="$sm">
			<Image source={flourishImage} style={styles.flourish} resizeMode="contain" />
		</YStack>
	)
}
...
export function PageBreakOrnament() {
	return (
		<YStack alignItems="center" paddingVertical="$md">
			<Image source={chaliceImage} style={styles.chalice} resizeMode="contain" />
		</YStack>
	)
}
