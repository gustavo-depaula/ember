// HTML entity decoder + chrome stripper for vatican.va archive HTML (Compendium
// and full Catechism). Numeric entities (&#x201c;, &#8220;) and the named
// entities we actually see on the site.
