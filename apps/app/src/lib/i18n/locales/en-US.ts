export default {
  ...
  memorize: {
    title: 'Memory work',
    subtitle: 'A few minutes a day. The prayer takes root.',
    portionLabel: 'Portion {{n}}',
    progress: '{{n}} of {{total}}',
    cuedHint: 'Recite the next line — then reveal.',
    lettersHint: 'Each letter is the start of a word.',
    coldHint: 'Recite the prayer from memory.',
    reveal: 'Reveal',
    revealLine: 'Reveal next line',
    revealText: 'Reveal full text',
    gotIt: 'Got it',
    missedIt: 'Missed it',
    couldntStart: 'Couldn’t get past the cue',
    tapLastLine: 'Tap the last line you got',
    sessionDone: 'Well learned. Until tomorrow.',
    sessionDoneAlt: 'The prayer is taking root.',
    empty: 'Nothing to memorize yet.',
    emptyHint: 'On a prayer’s page, tap "Learn by heart" to begin.',
    nothingToday: 'All caught up.',
    nothingTodayHint: 'No cards due today. Until tomorrow.',
    contentMissing: 'This prayer is unavailable right now.',
    skipCard: 'Skip',
    close: 'Close',
  },
