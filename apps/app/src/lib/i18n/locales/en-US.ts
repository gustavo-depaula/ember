export default {
  ...
  practice: {
    ...
    'catechetical-formation': 'Catechetical Formation',
    ...
    '01-trivial-prayer': 'Example: Trivial Prayer',
    '02-bilingual-prayer': 'Example: Bilingual Prayer with Rubric',
    '04-rosary-with-macros': 'Example: Rosary with Macros',
    '05-mass-of-with-choice-rich-text': 'Example: Mass via mass-of + choice-rich-text',
    pray: 'Pray',
