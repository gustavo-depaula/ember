export default {
  ...
  practice: {
    ...
    'catechetical-formation': 'Formação Catequética',
    'chaplet-of-divine-mercy': 'Terço da Divina Misericórdia',
    ...
    '01-trivial-prayer': 'Exemplo: Oração Simples',
    '02-bilingual-prayer': 'Exemplo: Oração Bilíngue com Rubrica',
    '04-rosary-with-macros': 'Exemplo: Rosário com Macros',
    '05-mass-of-with-choice-rich-text': 'Exemplo: Missa via mass-of + choice-rich-text',
    pray: 'Rezar',
