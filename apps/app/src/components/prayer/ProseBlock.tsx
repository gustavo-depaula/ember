    ...
    <>
      {nodes.map((node, i) => {
        switch (node.type) {
          case 'bold':
            return (
              <RNText key={i} style={{ fontFamily: 'EBGaramond_700Bold' }}>
                {node.text}
              </RNText>
            )
          case 'italic':
            return (
              <RNText key={i} style={{ fontFamily: 'EBGaramond_400Regular_Italic' }}>
                {node.text}
              </RNText>
            )
          case 'bolditalic':
            return (
              <RNText key={i} style={{ fontFamily: 'EBGaramond_700Bold_Italic' }}>
                {node.text}
              </RNText>
            )
          default:
