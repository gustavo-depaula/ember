...
// biome.json excludes this generated file from both the linter and the
// formatter (the embedded blob is unformattable + contains `${…}` sequences
// that would trip noTemplateCurlyInString). Re-add the exclude there if you
// rename the file.
const paginatorOut = `/**
