"""Print glossary rows whose first cell matches any regex (accent-folded), truncated to N chars (Ps 226 lookups).
python3.13 research/psalterium/ps226/gloss.py [-n 600] '<regex>' [...]"""
import sys
import unicodedata
import re
