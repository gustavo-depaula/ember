"""Append Ps 139 evidence to glossary rows; add the new Term row at the end of ## Terms and the formula row at the end of ## Formulas.
...
if any(l.startswith('| linguósus |') for l in lines):
