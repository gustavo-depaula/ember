"""Latin regex (accent-folded) -> each finished psalm's verse with its prayed Portuguese (canticle 225 lookups).
Adapted from ps131/concord.py, with accent folding.
python3.13 research/psalterium/ps225/concord.py '<regex>' [...]"""
import json
import re
import sys
import unicodedata
