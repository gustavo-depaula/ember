"""Append Ps 71 evidence to glossary rows; add the new Term row at the end of ## Terms and the formula row at the end of ## Formulas.
...
if any(l.startswith('| oríri |') for l in lines):
