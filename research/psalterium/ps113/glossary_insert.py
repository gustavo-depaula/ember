"""Ps 113's glossary work: appends via ps005/glossary_add.py, then the formula row inserted in psalm order
(after the last formula row whose first reference is <= 113). Idempotent; re-reads and writes in one go."""
import json
import re
import subprocess
import sys
