...
BOOK_DIR = Path("content/libraries/base/books/catechetical-instructions")
OUT_DIR = BOOK_DIR / "en-US"
SRC_TXT = Path("content/libraries/base/sources/english-originals/catechetical-instructions.txt")
