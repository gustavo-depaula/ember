...
WORKS_CC: dict[str, WorkSpec] = {
    ...
    "office-corpus-christi-sacerdos": WorkSpec(
        slug="office-corpus-christi-sacerdos",
        sub_path="office-of-corpus-christi-sacerdos",
        book_id="aquinas-office-corpus-christi-sacerdos",
        name_en="Office of Corpus Christi — Sacerdos in aeternum",
        name_la="Officium Corporis Christi — Sacerdos in aeternum",
        composed=1264,
        description_en="The canonical Office of Corpus Christi composed by Aquinas in 1264 at the request of Pope Urban IV — *Sacerdos in aeternum*, the recension ultimately adopted by the Church. Includes the four great Eucharistic hymns *Pange Lingua*, *Sacris Solemniis*, *Verbum Supernum*, and the sequence *Lauda Sion*. Aquinas Institute bilingual edition.",
        description_la="Officium Corporis Christi canonicum Thomae 1264, Urbano IV petente — recensio *Sacerdos in aeternum*, in usum Ecclesiae tandem recepta. Comprehendit hymnos Eucharisticos maximos *Pange Lingua*, *Sacris Solemniis*, *Verbum Supernum*, et sequentiam *Lauda Sion*.",
