...
--> statement-breakpoint
CREATE INDEX `idx_daily_office_date` ON `daily_office` (`date`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_practice_logs_date` ON `practice_logs` (`date`);--> statement-breakpoint
CREATE INDEX `idx_practice_logs_practice` ON `practice_logs` (`practice_id`);--> statement-breakpoint
