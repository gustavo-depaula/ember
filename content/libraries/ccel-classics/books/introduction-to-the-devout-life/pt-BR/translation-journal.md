# Diário de Tradução — Introdução à Vida Devota (pt-BR)

Fonte: en-US (Christian Classics Ethereal Library — tradução do francês original de 1609)
Alvo: pt-BR
Autor: São Francisco de Sales (1567–1622)

> **Nota sobre a fonte:** Idealmente esta tradução derivaria do francês original (*Introduction à la vie dévote*). Por decisão do projeto, esta passagem traduz a partir do inglês CCEL — uma tradução-de-tradução. Onde a passagem inglesa parecer obscura, oblíqua ou idiomaticamente forçada, suspeitar de artefato da tradução inglesa e preferir uma rendição portuguesa clara que respeite o sentido salesiano (gentileza, intimidade pastoral, precisão teológica).

## Decisão fundamental: forma de tratamento

A obra dirige-se a **Filoteia** ("amante de Deus") em segunda pessoa íntima e dignificada. Em todas as traduções clássicas para o português, usa-se **tu** com conjugação clássica (vens, queres, deves, lembra-te, considera, ouve), nunca "você" (familiar demais) nem "vós" (pluralidade arcaica reservada a orações). **Esta tradução adota uniformemente "tu" com conjugação clássica.**

Exemplos:
- "YOU aim at a devout life, dear child" → "Aspiras à vida devota, querida filha"
- "remember that..." → "lembra-te de que..."
- "consider..." → "considera..."
- "you must" → "deves" (não "você deve")
...
| Philothea / dear child | Filoteia / querida filha | "Filoteia" usado quando o original endereça pelo nome |
| soul | alma | |
...
| sinful affections | afeições pecaminosas | |
| temptation | tentação | |
| meditation | meditação | |
| prayer | oração | |
| ejaculatory prayer | oração jaculatória | |
...
| spiritual director / guide | diretor espiritual / guia | |
| Divine Majesty | Divina Majestade | |
| God's Word | a Palavra de Deus | |
| inspiration | inspiração | |
| general confession | confissão geral | |
| protest / hearty protest | protestação / protestação fervorosa | Termo técnico salesiano (acto solene de propósito) |
| firm resolution | firme resolução | |
| spiritual bouquet | ramalhete espiritual | Tradução tradicional do *bouquet spirituel* salesiano |
| presence of God | presença de Deus | |
| invocation | invocação | |
| affections | afetos | (no contexto da meditação) |
| resolutions | resoluções | |
| dryness | aridez | (na vida espiritual) |
| consolation (spiritual / sensible) | consolação (espiritual / sensível) | |
| spiritual barrenness | esterilidade espiritual | |
| desolation | desolação | |
| evil inclinations | más inclinações | |
| useless and dangerous things | coisas inúteis e perigosas | |
| virtue | virtude | |
| humility / interior humility | humildade / humildade interior | |
| patience | paciência | |
| gentleness | mansidão | "Doçura" também aceitável; preferir "mansidão" pelo paralelo bíblico (Mt 5,5) |
| obedience | obediência | |
| purity | pureza | |
| chastity | castidade | (quando aplicável) |
| poverty of spirit | pobreza de espírito | |
| friendship (real / evil / frivolous) | amizade (verdadeira / má / frívola) | |
| bodily mortification | mortificação corporal | |
| modesty in dress | modéstia no vestir | |
| conversation | conversação | (no sentido salesiano de trato social) |
| hasty judgments | juízos temerários | Termo técnico moral |
| slander | maledicência | "Difamação" como sinônimo |
| amusements / recreations | divertimentos / recreações | |
| balls | bailes | |
| married people | casados | |
| widows | viúvas | |
| maidens | virgens / donzelas | "Donzelas" se o tom for arcaico-elegante; "virgens" se o sentido for o estado |
| ordinary temptations | tentações comuns | |
| delectation | deleitação | (consentimento ao prazer pecaminoso) |
| consent (to temptation) | consentimento | |
| anxiety of mind | inquietação da alma | "Ansiedade" parece moderno demais; "inquietação" é salesiano |
| sadness / sorrow | tristeza / dor | |
| renewal of resolutions | renovação das resoluções | |
| worth of souls | valor das almas | |
| eternal love of God | amor eterno de Deus | |
| objections | objeções | |
| Saint / St. | São / Santo / Santa | Forma brasileira padrão |
| Our Lord | Nosso Senhor | |
| Jesus Christ | Jesus Cristo | |
| the Blessed Virgin | a Santíssima Virgem / a Bem-aventurada Virgem | |
...
| Paradise | o Paraíso | |
| the Cross | a Cruz | |
| Heart (sacred) | Coração (Sagrado) | |
| commandments | mandamentos | |
| counsels (of God) | conselhos | |
...
- **Tom:** salesiano — gentil, paterno, encorajador, com imagens vívidas (animais, plantas, vida cotidiana). Manter a calidez. Evitar tom severo ou jurídico.
- **Estrutura:** parágrafos preservados como no original. Cabeçalhos `#` e `##` exatos.
- **Citações latinas:** mantidas em itálico, com tradução portuguesa logo após, conforme o original o faça.
- **Referências bíblicas:** preservadas como estão (livro, capítulo, versículo).
- **Notas:** notas autorais preservadas; notas do tradutor adicionadas com extrema parcimônia (somente quando o leitor moderno realmente precisar de contexto). Cada nota do tradutor é registrada em `translator-notes-log.md`.
- **Nomes próprios de santos:** forma brasileira padrão (São João Crisóstomo, Santo Agostinho, São Bernardo, São Francisco de Sales, Santa Teresa de Ávila, etc.).
- **"Arelius"** (cap. I, parte I): manter como "Arelius" — referência clássica obscura sem tradução estabelecida.
- **"Michal"** (esposa de Davi): "Mical".

### Referência de tom (Montfort pt-BR)

A tradução irmã do *Tratado da Verdadeira Devoção* (Montfort) em pt-BR usa "vós" (forma de tratamento plural reverente) por se tratar de tom apostólico-pregação. **Esta tradução de São Francisco de Sales é diferente**: o santo escreve a uma única alma, em tom de direção espiritual íntima — daí "tu" com conjugação clássica.

## Expressões e idioms

(adicionar à medida que aparecem)

| Inglês | Português | Notas |
|---|---|---|
| "wax greater" | "tornar-se maior" / "agigantar-se" | "Wax" no sentido arcaico de "crescer" |
| "wont to" | "costuma" | |
| "lay figures" / "phantasms of devotion" | "manequins" / "fantasmas de devoção" | Imagens salesianas |
