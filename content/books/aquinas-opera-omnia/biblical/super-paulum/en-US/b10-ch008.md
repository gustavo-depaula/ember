# Chapter 8 — if(bInlineFloats) { document.write('<span id="WPFootnote8" class="WPFloatStyle">'); document.write(WPFootnote8); document.write('<br><a href="javascript:WPHide(\'WPFootnote8\')">Close<\/a>'); document.write('<\/span>'); } — Thirdly, from the example he draws his conclusion (v. 24).
