# Chapter 5 — if(bInlineFloats) { document.write('<span id="WPFootnote9" class="WPFloatStyle">'); document.write(WPFootnote9); document.write('<br><a href="javascript:WPHide(\'WPFootnote9\')">Close<\/a>'); document.write('<\/span>'); } — “In every thing, by prayer and supplication, with thanksgiving, let your petitions be made known to God” (Phil. 4:6).
