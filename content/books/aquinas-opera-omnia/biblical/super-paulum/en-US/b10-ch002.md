# Lecture 2 — if(bInlineFloats) { document.write('<span id="WPFootnote2" class="WPFloatStyle">'); document.write(WPFootnote2); document.write('<br><a href="javascript:WPHide(\'WPFootnote2\')">Close<\/a>'); document.write('<\/span>'); }
