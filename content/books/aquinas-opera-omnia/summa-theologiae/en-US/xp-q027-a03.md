...
Objection 1: It would seem that an indulgence can sometimes be granted to one who does not fulfill the required conditions, because when a person is unable to perform a certain action his will is taken for the deed. Now, sometimes an indulgence is to be gained by giving alms, which a poor man is unable to do, though he would do so willingly. Therefore, he can gain the indulgence.  

Obj. 2: Further, one man can make satisfaction for another. Now an indulgence is directed to the remission of punishment, just as satisfaction is. Therefore, one man can gain an indulgence for another; and so a man can gain an indulgence without doing that for which the indulgence is given.  
