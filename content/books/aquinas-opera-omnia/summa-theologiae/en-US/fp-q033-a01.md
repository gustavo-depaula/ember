...
Obj. 3: Further, the word principle is taken from priority. But in God there is no *before* and *after*, as Athanasius says. Therefore in speaking of God we ought not to use the term ‘principle’.  
...
Reply Obj. 1: The Greeks use the words *cause* and *principle* indifferently, when speaking of God; whereas the Latin Doctors do not use the word *cause*, but only *principle*. The reason is because *principle* is a wider term than *cause*; as *cause* is more common than *element*. For the first term of a thing, as also the first part, is called the principle, but not the cause.  
