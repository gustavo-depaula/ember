...
If affinity is caused by affinity a man who has connection with two women can marry neither of them, because then the one would be related to the other by affinity. But this is false. Therefore affinity does not cause affinity.
