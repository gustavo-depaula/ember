...
Further, the past is the proper object of the memory, according to the Philosopher (De Memoria i). Now penance regards the past, as stated above (Article [1], ad 2, ad 3). Therefore penance is subjected in the memory.
...
The will, as stated above (FP, Question [82], Article [4]; FS, Question [9], Article [1]), moves all the other powers of the soul; so that it is not unreasonable for penance to be subjected in the will, and to produce an effect in each power of the soul.
