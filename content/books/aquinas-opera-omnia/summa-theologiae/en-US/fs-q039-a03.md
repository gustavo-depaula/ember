...
Objection 1: It would seem that sorrow cannot be a useful good. For it is written (Sir 30:25): *Sadness hath killed many, and there is no profit in it*.  
...
Obj. 3: Further, *Everything is for the sake of its own operation*, as stated in *De Coel*. ii, 3. But *sorrow hinders operation*, as stated in *Ethic*. x, 5. Therefore sorrow is not a useful good.  
...
Reply Obj. 1: This passage is to be taken as referring to excessive sorrow, which consumes the soul: for such sorrow paralyzes the soul, and hinders it from shunning evil, as stated above (Q37, A2).  
...
Reply Obj. 3: Sorrow caused by an action hinders that action: but sorrow for the cessation of an action, makes one do it more earnestly.
