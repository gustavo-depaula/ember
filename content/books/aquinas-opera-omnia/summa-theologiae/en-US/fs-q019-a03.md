...
Further, the mover does not depend on that which is moved, but vice versa. But the will moves the reason and the other powers, as stated above (Question [9], Article [1]). Therefore the goodness of the will does not depend on reason.
...
The will moves the reason in one way: the reason moves the will in another, viz. on the part of the object, as stated above (Question [9], Article [1]).
