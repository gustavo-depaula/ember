...
Further, whatever is a matter of precept is sufficiently delivered to us in Holy Writ. Now the order of charity which was given above (Question [26]) is nowhere indicated in Holy Writ. Therefore it is not included in the precept.
...
As stated above (Article [4], ad 1), the mode which is essential to an act of virtue comes under the precept which prescribes that virtuous act. Now the order of charity is essential to the virtue, since it is based on the proportion of love to the thing beloved, as shown above (Question [25], Article [12]; Question [26], Articles [1],2). It is therefore evident that the order of charity must come under the precept.
