...
Obj. 2: Further, different orders are different grades, and grades among spirits are constituted by different spiritual gifts. But among the angels all the spiritual gifts are common to all, for *nothing is possessed individually* (*Sent*. ii, D, ix). Therefore there are not different orders of angels.  
...
On the contrary, The Apostle says (Eph 1:20,21) that *God has set the Man Christ above all principality and power, and virtue, and dominion*: which are the various orders of the angels, and some of them belong to one hierarchy, as will be explained (A. 6).  
