...
Further, it is written (Ecclus. 4:30): "In no wise speak against the truth." Now sometimes a person tells the truth while backbiting, as stated above (Article [1], ad 3). Therefore it seems that one is not always bound to withstand a backbiter.
