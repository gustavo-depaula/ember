...
Obj. 2: Further, pudicitia (purity) is derived from pudor, which is equivalent to shame. Now shame, according to Damascene, is about a disgraceful act, and this is common to all sinful acts. Therefore purity belongs no more to chastity than to the other virtues.  

Obj. 3: Further, the Philosopher says (*Ethic*. iii, 12) that *every kind of intemperance is most deserving of reproach*. Now it would seem to belong to purity to avoid all that is deserving of reproach. Therefore purity belongs to all the parts of temperance, and not especially to chastity.  
