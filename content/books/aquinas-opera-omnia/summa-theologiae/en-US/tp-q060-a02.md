...
A definition is convertible with the thing defined. Now some define a sacrament as being "the sign of a sacred thing"; moreover, this is clear from the passage quoted above (Article [1]) from Augustine. Therefore it seems that every sign of a sacred thing is a sacrament.
