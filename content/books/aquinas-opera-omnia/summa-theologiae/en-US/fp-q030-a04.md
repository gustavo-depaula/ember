...
Obj. 2: Further, the common is the opposite to the incommunicable. But the very meaning of person is that it is incommunicable; as appears from the definition given by Richard of St. Victor (Q. 29, A. 3, ad 4). Therefore this term *person* is not common to all the three persons.  
...
I answer that, The very mode of expression itself shows that this term *person* is common to the three when we say *three persons*; for when we say *three men* we show that *man* is common to the three. Now it is clear that this is not community of a real thing, in the way in which one essence is common to the three; otherwise, there would be only one person of the three, as also one essence.  
