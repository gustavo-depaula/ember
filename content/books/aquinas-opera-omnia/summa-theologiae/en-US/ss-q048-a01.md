...
Further, just as counselling, judging and commanding are acts of the practical reason, so also is using, as stated above (FS, Question [16], Article [1]). Therefore, just as "eubulia" which refers to counsel, is connected with prudence, and "synesis" and "gnome" which refer to judgment, so also ought something to have been assigned corresponding to use.

## Objection 5

Further, solicitude pertains to prudence, as stated above (Question [47], Article [9]). Therefore solicitude also should have been mentioned among the parts of prudence.
