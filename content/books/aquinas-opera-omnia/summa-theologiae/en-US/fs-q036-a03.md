...
Objection 1: It would seem that the craving for unity is not a cause of sorrow. For the Philosopher says (*Ethic*. x, 3) that *this opinion*, which held repletion to be the cause of pleasure, and division, the cause of sorrow, *seems to have originated in pains and pleasures connected with food*. But not every pleasure or sorrow is of this kind. Therefore the craving for unity is not the universal cause of sorrow; since repletion pertains to unity, and division is the cause of multitude.  
...
Reply Obj. 3: Separation from things hurtful and corruptive is desired, insofar as they destroy the unity which is due. Wherefore the desire for such like separation is not the first cause of sorrow, whereas the craving for unity is.
