...
Reply Obj. 3: It is true that contemplation enjoys rest from external movements. Nevertheless to contemplate is itself a movement of the intellect, insofar as every operation is described as a movement; in which sense the Philosopher says (*De Anima* iii, 7) that sensation and understanding are movements of a kind, insofar as movement is defined *the act of a perfect thing*. In this way Dionysius (*Div. Nom*. iv) ascribes three movements to the soul in contemplation, namely, *straight*, *circular*, and *oblique*.
