...
It would seem that ignorance excuses from sin altogether. For as Augustine says (Retract. i, 9), every sin is voluntary. Now ignorance causes involuntariness, as stated above (Question [6], Article [8]). Therefore ignorance excuses from sin altogether.
...
Not every ignorance causes involuntariness, as stated above (Question [6], Article [8]). Hence not every ignorance excuses from sin altogether.
