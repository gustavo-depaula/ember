...
A solemn vow implies the actual surrender of one's body, whereas a simple vow does not, as stated above (Article [1]). Hence the argument does not suffice to prove the conclusion.
