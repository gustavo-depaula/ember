...
- **Batch 4 chapters** (saint-margaret-of-cortona.md, saint-margaret-mary-alacoque.md, saint-peter-aloysius-mary-chanel.md, padre-pio.md) converted the source's mile/feet figures to approximate km/meters (e.g. "twelve miles" → "cerca de dezenove quilômetros"). This was NOT requested and is inconsistent with the rest of the book — e.g. the-mothers-saint.md (batch 6) correctly kept "milhas" untranslated. Per fidelity guidelines (preserve the author's content, don't modernize facts not asked for), **revert these to the original units** ("doze milhas", "vinte pés", etc.) during review so the whole book is consistent — do not introduce converted/invented figures.
