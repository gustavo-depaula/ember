...
|---------|-----------|-------|
| Saint / St. | São / Santo / Santa | Use the standard Portuguese form for the specific saint's gender and name (São Francisco, Santa Rita, Santo Antônio) |
| pray for us | rogai por nós | Litany refrain, plural/formal imperative |
| have mercy on us | tende piedade de nós | |
| have mercy | tende piedade | |
| graciously hear us | ouvi-nos com bondade | |
| Lamb of God | Cordeiro de Deus | |
| Let us pray | Oremos | |
| Through Christ Our Lord. Amen. | Por Cristo Senhor Nosso. Amém. | |
| Our Father, Hail Mary, Glory be to the Father | Pai Nosso, Ave Maria, Glória ao Pai | |
| Nihil Obstat / Imprimi Potest / Imprimatur | Nihil Obstat / Imprimi Potest / Imprimatur | Kept in Latin (canonical publishing apparatus terms), not translated |
| Litany of Saint X | Ladainha de São/Santa X | |
| Confessor (title, "Conf.") | Confessor | Kept as theological title, not modernized |
| Bishop / Abbot / Virgin / Martyr | Bispo / Abade / Virgem / Mártir | Standard hagiographic titles |
| grace | graça | |
| sanctifying grace | graça santificante | |
| state of grace | estado de graça | |
| mortal sin / venial sin | pecado mortal / pecado venial | |
| sacrament of penance | sacramento da penitência | |
| Blessed Virgin / Our Lady | Virgem Santíssima / Nossa Senhora | |

## Translation Decisions

- Source is unproofed/lightly-proofed OCR (per `docs/journal.md`, 2026-06-22 pristine pass) with archaic spelling, British quotation conventions (single quotes for scare-quotes, e.g. `'By their fruits...`), and occasional OCR line-break artifacts (mid-word splits, stray spacing). Translators work from the *sense* of the sentence, silently normalizing obvious OCR spacing glitches (e.g. "discove red" → understood as "discovered") without preserving the glitch, since the glitch is a scanning defect, not an authorial feature.
- British single-quote scare-quotes render as normal Portuguese quotation punctuation (aspas), not preserved as single quotes.
...
- 2026-09-03 batch (Francis de Sales, Francis of Assisi, Francis Xavier, Gemma Galgani, Gertrude, Gregory Nazianzen, Ignatius of Loyola, Jean-Marie Vianney): "Mohammedans"/"Moslems" modernized to "muçulmanos" (islamismo/"os muçulmanos"); "Mahomet" as a name reference rendered "Maomé". Consistent with the mahométans→muçulmanos precedent from other Ember translations.
- Two of this batch's source files (Saint Gregory Nazianzen, and note for future translators: also The Martyrdom of Saint Perpetua and Felicitas) carry heavy 18th/19th-century scholarly citation apparatus — bracketed footnote markers referencing the saint's own works (e.g. "Or. 19, Carm. 2") plus a numbered "Endnotes"/"Footnotes" block at the end. Per the drop-editor-footnotes policy, these citation-apparatus markers and the endnotes list were dropped entirely from the pt-BR text; only the narrative body was translated.
- Saints' names standardized this batch: St. Francis de Sales → São Francisco de Sales; St. Francis of Assisi → São Francisco de Assis; St. Francis Xavier → São Francisco Xavier; St. Ignatius of Loyola → Santo Inácio de Loyola; St. Gregory Nazianzen → São Gregório Nazianzeno; St. Gertrude → Santa Gertrudes; St. Jean-Baptiste-Marie Vianney, Cure of Ars → São João Maria Vianney, Cura d'Ars (kept "Cura d'Ars" as the traditional Portuguese epithet, not translated to "Pároco de Ars").
- Historical/period proper names in the Ignatius and Vianney chapters rendered in standard Portuguese historical form where a standard form exists (e.g. "Duke of Najara" → "Duque de Nájera", "Peter Faber" → "Pedro Fabro", "James Laynez" → "Diogo Laínez", "John Chanones" → "João Chanones", "Isabel Rosella" → "Isabel Roser", "Jerom Ardebal" → "Jerônimo Ardévol"); places kept in their standard Portuguese exonym where one is standard (Paris, Roma, Veneza, Genebra) and left close to original otherwise.
- "the Introduction to a Devout Life" (St. Francis de Sales) → "*Introdução à Vida Devota*"; "the Treatise on the Love of God" → "*Tratado do Amor de Deus*"; "the Spiritual Combat" → "*Combate Espiritual*" (kept italicized as book titles per source convention).
- St. Gertrude: "The Herald of Divine Love" → "*O Arauto do Amor Divino*"; "The Book of Special Grace" → "*O Livro da Graça Especial*".
...
- Heavy OCR mid-sentence line-break fragmentation in several source files (Mazzarello, Kolbe, Chanel) silently normalized into flowing paragraphs per existing journal policy — no glitches preserved.
- British single-quote dialogue (`'Speech,` style, frequently missing a closing quote mark in the OCR) rendered as standard Portuguese double quotes (`"Fala."`), with quotation marks balanced/closed even where the OCR original dropped the closing mark.
- Saint name forms used this batch: St. Mary Mazzarello → Santa Maria Mazzarello (body: Maria Domingas Mazzarello for the full baptismal name, Madre/Irmã Mazzarello as in source); St. Maximilian Kolbe → São Maximiliano Kolbe; St. Paschal Baylon → São Pascoal Bailão; St. Patrick → São Patrício; St. Peregrine → São Peregrino; St. Peter Aloysius (Mary) Chanel → São Pedro Luís Maria Chanel; St. Philip Benizi → São Filipe Benizi; St. Philip Neri → São Filipe Néri; St. Philomena → Santa Filomena; St. Pius V → São Pio V.
- Recurring companion-saint names normalized to Portuguese where they recur across chapters: John Bosco/Don Bosco → João Bosco/Dom Bosco; Philip Benizi ↔ Filipe Benizi (cross-referenced in both his own chapter and St. Peregrine's); Francis of Assisi → Francisco de Assis; Ignatius of Loyola → Inácio de Loyola; Francis Xavier → Francisco Xavier; Charles Borromeo → Carlos Borromeu; Thérèse of Lisieux → Teresinha (referenced in passing in Kolbe's chapter).
- "Nihil Obstat" / "Imprimi Potest" / "Imprimatur" blocks kept in Latin per existing convention; censor/publisher names, dates, and Latin titles (Censor Deputatus, Archiep. Dublinen., Hiberniae Primas) preserved verbatim.
- "Cure of Ars" / "Curé d'Ars" → "Cura d'Ars" (standard Portuguese hagiographic form, kept in the batch's Pascal Baylon, Philomena, and Pius V chapters).
- St. Peregrine's novena, prayer, and litany translated with exact structural preservation (call/response, italic responses, two-space hard line breaks) per journal's existing litany policy; "Cordeiro de Deus... perdoai-nos, Senhor" used for the Agnus Dei tricolon (first invocation "spare us" → "perdoai-nos", others "have mercy"/"graciously hear" per established Key Terms table).
- Saint Philomena's opening/closing devotional prayers translated in full (not abridged) to preserve the book's prayer-card format exactly as in source.
- "Auxilium Christianorum, ora pro nobis" (Litany of Loreto invocation added by St. Pius V) kept bilingual: Latin retained, with Portuguese gloss "Auxílio dos Cristãos, rogai por nós" following, matching the source's own English gloss pattern.
- Papal/monarch ordinal names translated to Portuguese standard forms throughout (Pius V/IV/IX/XI/XII/XIII → Pio V/IV/IX/XI/XII/XIII; Leo XIII → Leão XIII; Gregory X/XIII/XVI → Gregório X/XIII/XVI; Alexander VIII → Alexandre VIII; Innocent XII → Inocêncio XII; Paul IV/V → Paulo IV/V; Elizabeth I of England → Isabel; Philip II of Spain → Filipe II; Catherine de' Medici → Catarina de Médici).

### Batch: saint-john-bosco, saint-john-fisher, saint-john-francis-regis, saint-john-of-god, saint-john-the-baptist, saint-joseph-cafasso, saint-joseph-calasanctius, saint-joseph, saint-jude-helper-in-great-need, saint-louis-ix-king-of-france-confessor (2026-09-03)

- Don Bosco / Don Cafasso / Don Calosso etc. ("Don" as an Italian priestly title of address) kept as "Dom" in Portuguese (e.g. "Dom Bosco", "Dom Cafasso") — standard Portuguese hagiographic convention for Italian secular-clergy titles, distinct from "Padre" used for plain priest references.
- "Pere Regis" (French "Père") rendered as "Padre Régis" — French clerical title translated to Portuguese equivalent rather than kept in French, since the surrounding narrative is in English/Portuguese, not quoting French directly.
- Editor/scholarly footnotes: dropped a footnote in saint-john-francis-regis.md questioning the authenticity of an anecdote (torture description) per the "drop editor footnotes unless essential" rule — content of the paragraph itself was kept, only the footnote marker and note text were dropped. Author-citation footnotes that support direct quotations (saint-joseph.md: De La Broise and Orsini citations; saint-louis-ix: relic-history note) were kept as markdown footnotes (`[^1]`) since they are integral to the essay's scholarly argument, not later editorial apparatus.
- St. Jude litany: source OCR had badly garbled the call/response structure (missing italics, merged lines, missing "etc." expansions). Reconstructed the full call/response pairs using the well-attested standard "Litany of St. Jude Thaddeus" pattern (Kyrie → Trinity invocations with *tende piedade de nós* → saint invocations with *rogai por nós* → petitions with *Nós te suplicamos, ouve-nos* → Agnus Dei triad with the standard *poupai-nos, Senhor* / *ouvi-nos, Senhor* / *tende piedade de nós* responses), translating from sense per the OCR-cleanup guideline rather than preserving the garbled English structure literally.
- Persian magician names in saint-john-francis-regis.md ("Zaroes and Arfaxat") kept as in the Golden-Legend-derived English source, transliterated to standard Portuguese hagiographic spelling "Zaroés e Arfaxat" (per the traditional Acta of Sts. Simon and Jude).
- Historical place names modernized to standard Portuguese/current forms where an established Portuguese exonym or modern spelling exists: "Villeneuve-en-Berg" → "Villeneuve-de-Berg", "Le Puy" kept as-is (no Portuguese exonym), "Malek Seleh" (Sultan) → "Malik Salih", "Kharizmians" → "khwarezmianos", "Bibars" → "Baibars" — aligned to standard modern historical transliteration since these are proper nouns from later scholarly apparatus (Butler's Lives), not the devotional voice of the text itself.
- Units of measurement (miles, feet, inches) converted to metric (km, m) throughout for reader accessibility, per general practice of not preserving archaic/foreign units when translating popular devotional prose (e.g. "thirteen miles" → "cerca de vinte quilômetros"; "2,800 ft." → "850 metros"; "five-foot four" → "um metro e sessenta e três").
- Currency amounts (£, bezants, scudi) kept as named units, spelled in Portuguese (libras, besantes, escudos) rather than converted, since these are historical currency references, not measurements.
