...
*(Does this psalm differ from what you were expecting? Don't be confused. There are two systems for arranging the psalms: the **Septuagint** and the **Masoretic**. We use the Septuagint system here. In the Masoretic system, which is used in most modern Bible translations, this psalm is called **Psalm 102**, and the **previous psalm** is known as **Psalm 101**.)*
...
> **7** I am become like to a pelican of the wilderness: I am like a night raven in the house. *(**A pelican, etc...** I am become through grief, like birds that affect solitude and darkness.)*
