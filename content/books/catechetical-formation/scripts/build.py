    ...
    return {
        ...
        "description": {
            "en-US": (
                ...
                "Aquinas is silent, from the Roman Catechism of the Council of Trent (1566). Every "
                "session also carries a brief Ember-original pastoral reading that frames the verbatim "
                "catechism for the modern lay reader, drawing on Augustine, Liguori, John Paul II, and "
                "the wider tradition. Each session caps the doctrine with one verse of Scripture and "
                "closes with a brief reflection. The full text of the Catechism of Trent is appended "
                "to each session as 'Going Deeper' for those who want the longer form. Curated for "
                "young adults — beautiful, doctrinally complete, beginner-friendly but fruitful for "
                "everyone. All 433 questions of the Catechism of St. Pius X are covered."
            ),
            "pt-BR": (
                ...
                "Cada sessão traz ainda uma breve leitura pastoral original da Ember que situa o "
                "catecismo verbatim para o leitor leigo de hoje, recorrendo a Agostinho, Ligório, João "
                "Paulo II e à tradição mais ampla. Cada sessão coroa a doutrina com um versículo da "
                "Escritura e encerra com uma breve reflexão. O texto integral do Catecismo de Trento é "
                "anexado a cada sessão como 'Aprofundamento' para quem deseja a forma mais longa. "
                "Curada para jovens adultos — bela, doutrinariamente completa, amigável ao iniciante e "
                "frutuosa a todos. Todas as 433 perguntas do Catecismo de São Pio X estão cobertas."
            ),
        },
        "composed": "1273–1912",
