...
> **Status:** Design doc. Supersedes the v1 linear-scoring approach in `docs/plans/spiritual-checkup.md` §2.
> **Related issue:** #156
...
- Not app code — nothing here assumes any schema beyond "we can pick a leaf." See `docs/plans/spiritual-checkup.md` §4 for the eventual data model.
