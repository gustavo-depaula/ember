...
**Decision.** Recorded as a hard rule in `docs/plans/creators/README.md` §6.8 and in this phase's editorial process. We will not synthesize a creator's voice or augment their audio with TTS.
