...
| Axis | v1 | Later |
|---|---|---|
| Versions | **11 office versions** (Tridentine 1570/1888/1906, Divino Afflatu 1939/1954, Reduced 1955, Rubrics 1960, Monastic 1617/1930/1963/Barroux) — 7 fully hour-verified, 4 partial (see Status) | Ordo Praedicatorum (Dominican), Cistercian/Altovadensis, votive offices |
...
- Phase 1 (multi-version): 8 more office versions imported and selectable — Tridentine 1570/1888/1906, Divino Afflatu 1939, Reduced 1955, Monastic Tridentinum 1617, Monastic Divino 1930, Monastic Barroux. **7 of the 11 versions are fully hour-verified** against the Perl (the 3 originals + DA 1939, Reduced 1955, Monastic Divino 1930, Monastic 1617 — `verifiedHourVersions` in the strict differential). 4 are **partial** (`partialHourVersions`, smoke-tested to assemble without throwing): Tridentine 1570/1888/1906 have a systematic **Matins** divergence (the `Daya` psalm scheme + Tridentine lessons — Phase 1.5), and Barroux diverges only on the Saturday-BVM Sext chapter. Settings drives the selector from `doVersionOrder`; `Martyrologium1570`/`1955R` imported for their Prime. EF Mass still maps every version to a verified missal (1960 or DA) via `massVersion` until per-version Mass verification lands.
